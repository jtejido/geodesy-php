...
This has been helpful to me at a time when working out the distance between different vendors and the user's current location (and check if they're within a certain range) and has grown beyond my simple use case and finally becoming a library.
