...
class PD83 extends BaseDatum implements DatumInterface
{
	...
	CONST DATUM = array (
			...
			'Scale' => 0,
			'Area' => "Germany - Thuringen",
			'Remarks' => "These parameter values are taken from DHDN to ETRS89 (8) (code 15948) as PD/83 and ETRS89 may be considered equivalent to DHDN and WGS 84 respectively within the accuracy of the transformation.",
			'Source' => "OGP",
